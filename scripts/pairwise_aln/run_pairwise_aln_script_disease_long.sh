...
genotype_log_dir="/nucleus/projects/saraj/vntr/sources/pangenome_project/logs/logs_genotype_disease_long_w_advntr_1.5.0"
aln_log_dir="/nucleus/projects/saraj/vntr/sources/pangenome_project/logs/logs_pairwise_align_disease_long"
...
for log_file_from_advntr in $(ls ${genotype_log_dir}/*.log); do
