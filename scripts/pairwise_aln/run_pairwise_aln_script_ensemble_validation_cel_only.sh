...
genotype_log_dir="/nucleus/projects/saraj/vntr/sources/pangenome_project/logs/logs_genotype_ensemble_validation_cel_only"
aln_log_dir="/nucleus/projects/saraj/vntr/sources/pangenome_project/logs/logs_pairwise_align_ensemble_validation_cel_only"
...
for log_file_from_advntr in $(ls -t ${genotype_log_dir}/*.log | grep "HG01175"); do
    #for vid in 290964 4237 674126 915594 123860 515774 525610 30693 564306; do
    for vid in 915594; do
        echo "----------------" >> $command_output
