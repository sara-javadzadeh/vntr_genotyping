...
parent_log_dir="/nucleus/projects/saraj/vntr/sources/pangenome_project/logs/logs_genotype_giab_hifi_integrated_inconsistent_vntrs"
...
for sample_name in HG002 HG003 HG004; do
    ...
    for input_bam_file in $(ls ${samples_dir}/${sample_name}/*.bam); do
        ...
        vids=$(cat $inconsistent_vntrs_file | tr '\n' ',' | sed -E 's/,$//g')
        echo "vids $vids"
