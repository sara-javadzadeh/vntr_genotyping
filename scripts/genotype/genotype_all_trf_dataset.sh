...
log_dir="/nucleus/projects/saraj/vntr/sources/pangenome_project/logs/logs_genotype_all_trf_dataset"
...
batch_1="HG02622 HG03540"
batch_2="HG01258 HG02559"
batch_3="HG02257 HG02148"
batch_4="HG02717 HG02630"
batch_5="HG02486 HG01175"
batch_6="HG01123 HG01891"

for input_sample_dir in $(echo $batch_1); do
    ...
    for input_bam_file in $(ls $samples_dir/$input_sample_dir/*.bam); do
        ...
        ulimit -n 8192
        /usr/bin/time -v advntr genotype --alignment_file $input_bam_file --working_directory $log_dir -m $all_vntr_db --pacbio --log_pacbio_reads &>> $output
    done
done
